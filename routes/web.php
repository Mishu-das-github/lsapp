...
/* Product Routes
All the routes for product for frontend
 */

Route::group(['prefix' => 'products'], function () {

    Route::get('/', 'Frontend\ProductsController@index')->name('products');
    Route::get('{slug}', 'Frontend\ProductsController@show')->name('product.slug');
...
Route::group(['prefix' => 'carts'], function () {
    ...
    Route::post('/destroy/{id}', 'Frontend\CartsController@destroy')->name('carts.destroy');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/password/resetPost', 'Auth\Admin\ResetPasswordController@reset')->name('admin.password.update');
